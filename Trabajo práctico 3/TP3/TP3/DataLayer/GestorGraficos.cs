...
namespace TP3.DataLayer
{
    ...
    class GestorGraficos
    {
        ...
        private List<ValorGenerado> muestras; //de acá saco los numeros aleatorios
        ...
        public void contarFrecuencias()
        {
            ...
            {
                double rand = muestras[i].getValorGenerado();
        ...
        public void setMuestras(List<ValorGenerado> valoreGenerados)
        {
            this.muestras = valoreGenerados;
        }
